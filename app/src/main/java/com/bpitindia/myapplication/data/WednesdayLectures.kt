...
class WednesdayLectures {
    fun loadLectures() : List<Period> {
        return listOf(
            ...
            Period("Software Testing", "402", "Dr. Vishal", LocalTime.of(11,10),  LocalTime.of(12,0)),
            Period("Library", "Lib", "Library Assistant", LocalTime.of(12,0),  LocalTime.of(12,50)),
            Period("Wireless Communication", "113", "Mr. Dinesh", LocalTime.of(1,40),  LocalTime.of(3,20)),
//            Period("IS Lab (G2)","108B","Dr. Charu", "3:20 - 5:00"),
            Period("DM Lab", "401A", "Dr. Mugdha", LocalTime.of(3,20),  LocalTime.of(5,0))
        )
    }
}