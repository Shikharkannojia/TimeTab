...
//            Period("ST Lab (G1)", "401A", "Dr. Vishal", "11:10 - 12:50"),
            Period("WC Lab", "108A", "Dr. Dinesh", LocalTime.of(11,10), LocalTime.of(12,50)),
            Period("Advanced DBMS", "114", "Ms. Deepti", LocalTime.of(1,40), LocalTime.of(2,30)),
            Period("Wireless Communication", "114", "Dr. Dinesh", LocalTime.of(2,30), LocalTime.of(3,20)),
